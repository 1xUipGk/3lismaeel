...
export const metadata: Metadata = {
  ...
  description: ' علي إسماعيل - مصمم جرافيك محترف متخصص في تصميم السوشيال ميديا، الفلايرات، البروشورات، قوائم الطعام، البطاقات الشخصية، أغلفة الكتب والمزيد من التصاميم الإبداعية',
  keywords: [
    'تصميم سوشيال ميديا',
    'تصميم فلايرات',
    'تصميم بروشورات',
